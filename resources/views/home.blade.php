        ...
        <div class="col-5 gap-4 p-4 position-relative start-0 justify-content-evenly mainbar">
            <div class="card" style="width: 18rem;">
                ...
                <div class="card-body bg-info-subtle">
                    ...
                    <a href="/consultations" class="btn btn-primary col-12 mb-1 mt-2">CONSULTATION</a>
                    @endif
            ...
            <div class="card" style="width: 18rem;">
                ...
                <div class="card-body bg-info-subtle">
                    @if(Auth::user()->role_id==1)
                    <a href="/grooming_services" class="btn btn-primary col-12 mb-1 mt-2">GROOMING SERVICE</a>
                    @endif
                    @if(Auth::user()->role_id==2)
            ...
            <div class="card" style="width: 18rem;">
                ...
                <div class="card-body bg-info-subtle">
                    @if(Auth::user()->role_id==1)
                    <a href="/pet_boardings" class="btn btn-primary col-12 mb-1 mt-2">PET BOARDING</a>
                    @endif
                    @if(Auth::user()->role_id==2)
